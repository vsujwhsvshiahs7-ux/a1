    ...
    <div class="container">
      <div style="display: grid; grid-template-columns: 1.2fr 0.8fr; gap: 3rem; align-items: center;">
        ...
        <div style="position: relative; border-radius: 16px; overflow: hidden; border: 1px solid var(--border-gold); box-shadow: 0 20px 50px rgba(0, 0, 0, 0.8);">
          <img src="https://images.unsplash.com/photo-1579586337278-3befd40fd17a?auto=format&fit=crop&w=800&h=600&crop=faces&watch_truly_fresh=15" alt="TickClockVan Mechanical Tourbillon Wristwatch Movement" style="width: 100%; height: 500px; object-fit: cover;">
  ...
  <section class="section" id="story" style="background: var(--bg-surface); color: var(--text-light);">
    <div class="container">
      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 4rem; align-items: center;">
        ...
        <div>
          <img src="https://images.unsplash.com/photo-1565849904461-04a58ad377e0?auto=format&fit=crop&w=800&h=600&crop=top&watch_truly_fresh=16" alt="TickClockVan Master Watchmaker Loupe Workshop" style="border-radius: 16px; border: 1px solid var(--border-gold);">
        </div>
      </div>
    </div>
  </section>
      ...
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(350px, 1fr)); gap: 2rem;">
        ...
        <div class="clock-card">
          <div class="clock-img-wrap">
            <img src="https://images.unsplash.com/photo-1555529669-e69e7aa0ba9a?auto=format&fit=crop&w=800&h=600&crop=center&watch_truly_fresh=17" alt="The Sovereign Flying Tourbillon Chronograph">
          </div>
        ...
        <div class="clock-card">
          <div class="clock-img-wrap">
            <img src="https://images.unsplash.com/photo-1533227268428-f9ed0900fb3b?auto=format&fit=crop&w=800&h=600&crop=bottom&watch_truly_fresh=18" alt="The Heritage Monopusher Chronograph">
          </div>
          <div class="clock-body">
        ...
        <div class="clock-card">
          <div class="clock-img-wrap">
            <img src="https://images.unsplash.com/photo-1521747116042-5a810fda9664?auto=format&fit=crop&w=800&h=600&crop=entropy&watch_truly_fresh=19" alt="The Skeleton Automatic GMT Timepiece">
          </div>
          <div class="clock-body">
    ...
    <div class="container">
      ...
      <div class="horology-gallery">
        <div class="gallery-tile">
          <img src="https://images.unsplash.com/photo-1617043786394-f977fa12eddf?auto=format&fit=crop&w=800&h=600&crop=faces&watch_truly_fresh=20" alt="Master Watchmaker Inspecting Watch Movement under Loupe">
        </div>
        <div class="gallery-tile">
          <img src="https://images.unsplash.com/photo-1619252584172-a83a949b6efd?auto=format&fit=crop&w=800&h=600&crop=top&watch_truly_fresh=21" alt="Mechanical Watch Movement Gear Assembly Workbench">
        </div>
        <div class="gallery-tile">
          <img src="https://images.unsplash.com/photo-1520607162513-77705c0f0d4a?auto=format&fit=crop&w=800&h=600&crop=center&watch_truly_fresh=22" alt="Mobile Watchmaker Van Fitting Lounge Experience">
        </div>
      </div>
    </div>
  </section>
      ...
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(320px, 1fr)); gap: 2rem;">
        <div class="blog-card">
          <div class="blog-img-wrap">
            <img src="https://images.unsplash.com/photo-1609587312208-cea54be969e7?auto=format&fit=crop&w=800&h=600&crop=bottom&watch_truly_fresh=23" alt="Mastering Tourbillon Watch Movement Physics">
          </div>
          <div class="blog-body">
        ...
        <div class="blog-card">
          <div class="blog-img-wrap">
            <img src="https://images.unsplash.com/photo-1579586337278-3befd40fd17a?auto=format&fit=crop&w=800&h=600&crop=entropy&watch_truly_fresh=24" alt="Free-Sprung Balance Spring Regulation in Wristwatches">
          </div>
          <div class="blog-body">
        ...
        <div class="blog-card">
          <div class="blog-img-wrap">
            <img src="https://images.unsplash.com/photo-1565849904461-04a58ad377e0?auto=format&fit=crop&w=800&h=600&crop=faces&watch_truly_fresh=25" alt="Column-Wheel Chronograph Mechanics & Power Reserve">
          </div>
          <div class="blog-body">
